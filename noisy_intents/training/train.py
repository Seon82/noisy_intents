        ...
        for epoch in range(epochs):
            ...
            with progress:
                ...
                for minibatch in train_loader:
                    ...
                    progress.update(train_task_id, advance=train_loader.batch_size, metrics=metrics_text, refresh=True)
                ...
                with progress:
                    ...
                    for minibatch in val_loader:
                        ...
                        for metric in metrics:
                            metric(predictions.argmax(axis=-1), batch_y)
                        # Update progress bar
                        progress.update(val_task_id, advance=val_loader.batch_size, metrics="", refresh=True)
